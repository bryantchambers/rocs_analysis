...
biomformat::write_biom(st_biom, biom_file = "results/microbial/sourcetracker/st_sp_median_wviruses-non-dmg.biom")
...
st_ps |>
    ...
    distinct() |>
    rename("#SampleID" = Sample) |>
    write_tsv("results/microbial/sourcetracker/st_sp_median_wviruses-non-dmg.map")
