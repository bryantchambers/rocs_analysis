...
EUK_OUT="/projects/caeg/people/ngm902/apps/repos/rocs/taxonomic-profiling/eukaryotes/unicorn_rerun_new_metadmg"
EUK_DIR="$EUK_OUT"
LOGS="/projects/caeg/people/ngm902/apps/repos/rocs/taxonomic-profiling/eukaryotes/unicorn_rerun_new_metadmg/logs"
...
# SLURM controls
# ---------------------------
MAX_PARALLEL_JOBS="${MAX_PARALLEL_JOBS:-150}"
...
process_sample() {
    ...
    if all_outputs_exist "$dfit" ; then
    ...
    if ! all_outputs_exist "$dfit"; then
        log_missing_outputs "$sample" "metadmg_dfit" "$dfit" 
