...
cat("## Output Map\n\n")
cat("- Reference candidates: `networkQC/input_evaluation/results/alr_quick_check/alr_reference_candidates.tsv`\n")
cat("- Summary: `networkQC/input_evaluation/results/alr_quick_check/alr_quick_check_summary.tsv`\n")
cat("- Module overlap: `networkQC/input_evaluation/results/alr_quick_check/alr_module_overlap_to_current.tsv`\n")
cat("- Preservation: `networkQC/input_evaluation/results/alr_quick_check/alr_preservation_all.tsv`\n")
cat("- Concordance: `networkQC/input_evaluation/results/alr_quick_check/alr_eigengene_concordance_all.tsv`\n")
cat("- Heatmap: `networkQC/input_evaluation/results/alr_quick_check/figures/alr_quick_check_heatmap.png`\n")
sink()
