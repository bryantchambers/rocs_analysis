...
cat("## Output Map\n\n")
cat("- Input variants: `InputQC/results/inputs/*.rds`\n")
cat("- Summary table: `InputQC/results/sensitivity/input_sensitivity_summary.tsv`\n")
cat("- Module overlap details: `InputQC/results/sensitivity/module_overlap_to_current.tsv`\n")
cat("- Preservation details: `InputQC/results/sensitivity/preservation_all.tsv`\n")
cat("- Concordance details: `InputQC/results/sensitivity/eigengene_concordance_all.tsv`\n")
cat("- Heatmap: `InputQC/results/figures/input_sensitivity_heatmap.png`\n")
sink()
